                    ...
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">
                               <g:message code="vocab.id.label" default="Id" />:
                            </td>
                            
                            <td valign="top" class="value">${fieldValue(bean:vocabInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:vocabInstance, field:'vocab')}</td>
